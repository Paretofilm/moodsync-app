...
export default function MoodInsights({ userId }: MoodInsightsProps) {
  ...
  const generateMockAIInsights = (
    ...
    const moodLabel =
      dominantMood && MOOD_TYPES[dominantMood]
        ? MOOD_TYPES[dominantMood].label.toLowerCase()
        : "varied";
    const insights = [
        ...
        <div className="insight-card current-week">
          ...
          <div className="insight-content">
            ...
            <div className="insight-meta">
              <span>
                Dominant mood:{" "}
                {currentWeekInsight.dominantMood &&
                MOOD_TYPES[currentWeekInsight.dominantMood] ? (
                  <>
        ...
        <div className="historical-insights">
          ...
          <div className="insights-list">
            {insights.slice(currentWeekInsight ? 1 : 0).map((insight) => (
              <div
                key={`${insight.userId}-${insight.weekStartDate}`}
                className="insight-card historical"
              >
                <div className="insight-header">
                ...
                <div className="insight-summary">
                  ...
                  <p className="dominant-mood">
                    ...
                    MOOD_TYPES[insight.dominantMood] ? (
                      <>
